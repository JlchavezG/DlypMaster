...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@700&display=swap" rel="stylesheet">
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="img/Logo_borde.png">
...
<div class="contenedor_loader">
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-danger">
      <div class="container-fluid">
        ...
        <img  src="img/Logo_borde.png" alt="" width="100" height="50" class="d-inline-block align-text-top">
       </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-light" href="desarrollo.html">Ayuda</a>
            </li>&nbsp;&nbsp;
            <!-- <li class="nav-item"> -->
       <!-- <a class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#ModalSesion"  href="Login.html">Iniciar sesion..</a> -->
        <!-- </li>&nbsp;&nbsp; -->
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="PerfilFree.html">Perfil</a></li>
            <li><a class="dropdown-item" href="include/cerrar.php">Cerrar sesion</a></li>
          </ul>
        </li>
...
<center><div class="card" style="width: 700px; height: auto; max-width: 100%; background-color: transparent; border-color: transparent;">
  ...
  <div class="card-body">
    ...
    <p class="card-text" style="font-size: 20px;">El Desfile de Día de Muertos, como parte de la tradición mexicana, buca recordar y conmemorar los difuntos.</p>
  </div>
