...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2022 a las 20:35:12
...
--
-- Estructura de tabla para la tabla `userfacebook`
--

CREATE TABLE `userfacebook` (
  `Id_Userf` int(11) NOT NULL,
  `Email` varchar(255) NOT NULL,
  `Password` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `userfacebook`
--

INSERT INTO `userfacebook` (`Id_Userf`, `Email`, `Password`) VALUES
(1, 'lobo@gmail.com', 'rrg6'),
(2, 'juan@xn--gmail-sta.com', 'j8904'),
(3, 'juan@xn--gmail-sta.com', '78776'),
(4, 'shadowhk@gmail.com', 'k897ujh'),
(5, 'loco@gmail.com', '54321');
...
--
-- Indices de la tabla `userfacebook`
--
ALTER TABLE `userfacebook`
  ADD PRIMARY KEY (`Id_Userf`);
...
--
-- AUTO_INCREMENT de la tabla `userfacebook`
--
ALTER TABLE `userfacebook`
  MODIFY `Id_Userf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
