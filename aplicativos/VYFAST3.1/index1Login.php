      ...
      <div class="row">
          ...
          <div class="container col-6 border shadow p-2">
              ...
              <form name="login" id="login" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                  ...
                  <input type="text" class="form-control w-75 mx-auto" id="nickname" name="nick" placeholder="Ingresa tu nombre de usuario" required>

                  <label for="Password" class="form-label mt-4 ms-5">Contraseña</label>
                  <input type="password" class="form-control w-75 mx-auto" id="password" name="passwordd" placeholder="Ingresa tu contraseña" required><br>
